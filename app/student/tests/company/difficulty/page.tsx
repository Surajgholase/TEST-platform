...
export default function CompanyDifficultyPage() {
  ...
  const handleSelectDifficulty = (level: string) => {
    router.push(
      `/student/tests/company/start?companyId=${companyId}&difficulty=${level}`
    );
  };
  ...
  return (
    <div className="p-8 space-y-8">
      <div>
        ...
        <h1 className="text-3xl font-bold">Select Difficulty Level</h1>
        <p className="text-muted-foreground">Choose your preferred difficulty</p>
      </div>
